...
v14.Size = UDim2.new(586.2 - (103 + 483), 0, 235.1 - (23 + 212), 0)
v14.Position = UDim2.new(1846.02 - (1228 + 618), 0, 0.2, 0)
v14.BackgroundColor3 = Color3.fromRGB(1013 - 758, 952 - (802 + 150), 0)
v14.Text = "ASCEND"
v14.Parent = v12

local v20 = Instance.new("TextButton")
v20.Size = UDim2.new(0.15, 0, 0.08, 0)
v20.Position = UDim2.new(0.1, 0, 0.8, 997 - (915 + 82))
v20.BackgroundColor3 = Color3.fromRGB(722 - 467, 0, 0)
v20.Text = "CONTROL"
v20.Parent = v12

local v26 = Instance.new("Frame")
v26.Size = UDim2.new(0.3, 0, 1187.12 - (1069 + 118), 0)
v26.Position = UDim2.new(0.35, 0, 0.6, 0)
v26.BackgroundColor3 = Color3.fromRGB(44 - 19, 25, 25)
v26.Visible = false
v26.Parent = v12

local v32 = Instance.new("TextLabel")
v32.Size = UDim2.new(1, 0, 0.3, 791 - (368 + 423))
v32.BackgroundTransparency = 3 - 2
v32.Text = "Speed: 70"
v32.TextColor3 = Color3.fromRGB(255, 255, 273 - (10 + 8))
v32.TextScaled = true
v32.Parent = v26

local v39 = Instance.new("Frame")
v39.Size = UDim2.new(0.9, 0, 0.4, 442 - (416 + 26))
v39.Position = UDim2.new(0.05, 0, 0.5, 0)
v39.BackgroundColor3 = Color3.fromRGB(693 - (145 + 293), 255, 685 - (44 + 386))
v39.Parent = v26

local v44 = Instance.new("Frame")
v44.Size = UDim2.new(1486.05 - (998 + 488), 0, 1, 0)
v44.Position = UDim2.new(772.07 - (201 + 571), 0, 1138 - (116 + 1022), 0)
v44.BackgroundColor3 = Color3.fromRGB(150 + 105, 0, 0)
v44.Parent = v39

local v49 = Instance.new("TextLabel")
v49.Size = UDim2.new(0.3, 859 - (814 + 45), 0.1, 0)
v49.Position = UDim2.new(0.35, 0, 885.35 - (261 + 624), 0)
v49.BackgroundTransparency = 1081 - (1020 + 60)
v49.Text = "Made by Keita"
v49.TextColor3 = Color3.fromRGB(1678 - (630 + 793), 863 - 608, 1207 - 952)
v49.TextScaled = true
v49.Parent = v12
v49.Visible = false
...
local function v67()
    local v70 = 1747 - (760 + 987)
    local v71
    while true do
        if (v70 == (1914 - (1789 + 124))) then
            v63 = Instance.new("BodyVelocity")
            v63.Velocity = Vector3.new(766 - (745 + 21), 25, 0)
            v70 = 2
        end
        if (v70 == (7 - 4)) then
            v62 = v1.Heartbeat:Connect(function(v97)
                ...
                while true do
                    ...
                    if (v98 == 3) then
                        v61.Velocity = v102 * (232 - 147)
                        break
                    end
                    if (v98 == (1819 - (1703 + 114))) then
                        v101 = Vector3.new(v6.Position.X + v99, v60 + (713 - (376 + 325)), v6.Position.Z + v100)
                        v102 = (v101 - v61.Position).unit
                        v98 = 4 - 1
                    end
                    if (v98 == 1) then
                        v99 = math.cos(v71) * 5
                        v100 = math.sin(v71) * (15 - 10)
                        v98 = 1 + 1
                    end
                end
            end)
        ...
        if (v70 == 0) then
            if (not v61 or v59) then
                return
            end
            v71 = 0
            v70 = 15 - (9 + 5)
        end
        if (v70 == (378 - (85 + 291))) then
            v63.MaxForce = Vector3.new(5265 - (243 + 1022), 15220 - 11220, 4000)
            v63.Parent = v61
            v70 = 3
        end
    end
...
v1.Heartbeat:Connect(function()
    if v58 then
        if (v6.Position.Y < v60) then
            v6.Velocity = Vector3.new(0, 25, 1180 - (1123 + 57))
        else
            v6.Velocity = Vector3.new(0, 254 - (163 + 91), 1930 - (1869 + 61))
...
local function v68()
    ...
    v73.MaxForce = Vector3.new(1535952 - 535952, 136839 + 863161, 1374247 - 374247)
    v73.Parent = v61
    local v76
    v76 = v1.Heartbeat:Connect(function()
        local v82 = 0
        while true do
            if (v82 == (1474 - (1329 + 145))) then
...
-- ==========================================
-- HÀM TOGGLE ĐÃ ĐƯỢC TỐI ƯU HÓA & LÀM SẠCH
-- ==========================================
local function ToggleAscend()
    if v58 then 
        v58 = false
        v14.Text = "ASCEND"
        v11:Stop()
...
-- Kết nối sự kiện Click nút trên màn hình
v14.MouseButton1Click:Connect(ToggleAscend)
v20.MouseButton1Click:Connect(ToggleControl)
...
v1.RenderStepped:Connect(function()
    if v69 then
        ...
        v44.Position = UDim2.new(math.clamp(v89, 0, 1) - 0.025, 0, 0, 0)
        v65 = math.floor(10 + (v89 * 240))
        v32.Text = "Speed: " .. tostring(v65)
    end
end)

-- Kết nối sự kiện gõ phím (Z và Y)
v2.InputBegan:Connect(function(v80, v81)
    if v81 then return end
    
    if v80.KeyCode == Enum.KeyCode.Z then
        ToggleControl()
    elseif v80.KeyCode == Enum.KeyCode.Y then
        ToggleAscend()
    end
end)
